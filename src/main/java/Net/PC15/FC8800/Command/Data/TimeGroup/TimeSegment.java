...
public class TimeSegment {
   ...
   public void SetBytes(ByteBuf bBuf) {
      this.mBeginTime[0] = (short)ByteUtil.BCDToByte(bBuf.readByte());
      this.mBeginTime[1] = (short)ByteUtil.BCDToByte(bBuf.readByte());
      this.mEndTime[0] = (short)ByteUtil.BCDToByte(bBuf.readByte());
      this.mEndTime[1] = (short)ByteUtil.BCDToByte(bBuf.readByte());
   }
}
