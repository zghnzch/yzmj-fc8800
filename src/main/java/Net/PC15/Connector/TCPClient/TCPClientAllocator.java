...
public class TCPClientAllocator {
   ...
   public TCPClientAllocator() {
      ((Bootstrap)((Bootstrap)((Bootstrap)((Bootstrap)((Bootstrap)this.TCPBootstrap.group(NettyAllocator.GetClientEventLoopGroup())).channel(NioSocketChannel.class)).option(ChannelOption.SO_KEEPALIVE, true)).option(ChannelOption.TCP_NODELAY, true)).option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 30000)).handler(this.TCPInitializer);
   }
