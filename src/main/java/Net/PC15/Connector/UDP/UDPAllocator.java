...
public class UDPAllocator {
   ...
   public UDPAllocator() {
      ((Bootstrap)((Bootstrap)((Bootstrap)this.UDPBootstrap.group(NettyAllocator.GetClientEventLoopGroup())).channel(NioDatagramChannel.class)).option(ChannelOption.SO_BROADCAST, false)).handler(new UDPChannelInitializer());
   }
